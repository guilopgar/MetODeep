...
def main():
    ...
    parser.add_argument('-cnn', dest='cnn', type=str,
                        help='name of the CNN model to be trained. \'DeepBind\' and \'MusiteDeep\' are accepted.',
                        required=False, default="MusiteDeep")
    parser.add_argument('-lr', dest='lr', type=float,
                        help='value of the learning rate used by the Adam optimizer when pre-training the model.',
